  ...
  return (
    <div className="mx-auto w-full max-w-xl px-6 py-8">
      <button
        type="button"
        onClick={() => router.back()}
        className="mb-4 -ml-2 flex items-center gap-1.5 rounded-md px-2 py-1.5 text-[13px] text-muted-foreground hover:bg-foreground/[0.04] hover:text-foreground"
      >
